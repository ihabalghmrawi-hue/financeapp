    ...
    <>
        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              className="bg-red-500/10 text-red-400 text-sm p-3.5 rounded-xl border border-red-500/20"
            >
              {error}
            </motion.div>
          )}
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all auth-text hover:brightness-110 text-xs font-medium disabled:opacity-50"
        >
          {googleLoading ? (
    ...
    <Suspense
      fallback={
        <div className="space-y-4 animate-pulse">
          <div className="h-10 bg-white/5 rounded-xl shimmer" />
          <div className="h-10 bg-white/5 rounded-xl shimmer" />
