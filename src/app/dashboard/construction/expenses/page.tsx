...
export default async function ConstructionExpensesPage({ searchParams }: { searchParams: Promise<{ page?: string }> }) {
  ...
  const [{ data: expenses, count }, { data: projects }] = await Promise.all([
    admin
      .from('con_expenses')
